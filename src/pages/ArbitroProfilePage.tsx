...
const ARBITRO = {
  name: "Carlos Ramírez",
  mail: "carlos.arbitro@techcup.com",
            ...
            >
              ...
              <div className="px-6 py-2 flex flex-col gap-2">
                <div className="flex items-center justify-between border-b border-white/10 py-3 gap-4">
                  ...
                  <span className="text-white font-semibold text-sm" style={{ fontFamily: "'Russo One', sans-serif" }}>{ARBITRO.name}</span>
                </div>
                <div className="flex items-center justify-between border-b border-white/10 py-3 gap-4">
                  <span className="text-white/50 text-sm min-w-[120px]">Correo</span>
                  <span className="text-white font-semibold text-sm" style={{ fontFamily: "'Russo One', sans-serif" }}>{ARBITRO.mail}</span>
                </div>
                <div className="flex items-center justify-between border-b border-white/10 py-3 gap-4">
                  <span className="text-white/50 text-sm min-w-[120px]">Edad</span>
                  <span className="text-white font-semibold text-sm" style={{ fontFamily: "'Russo One', sans-serif" }}>{calcAge(ARBITRO.dateOfBirth)}</span>
                </div>
                <div className="flex items-center justify-between border-b border-white/10 py-3 gap-4">
                  <span className="text-white/50 text-sm min-w-[120px]">Género</span>
                  <span className="text-white font-semibold text-sm" style={{ fontFamily: "'Russo One', sans-serif" }}>{ARBITRO.gender}</span>
                </div>
              </div>
            </div>
          </div>
